...
function frase (nome, pronome, objeto){
    return `${nome} foi caminhar no parque. ${pronome} encontrou um ${objeto}. ${nome} decididiu levar o ${objeto} para casa.`
    
}

frase ("Carla", "Ela", "celular")
...
function maior_numero(arr) {
    return Math.max.apply(null, arr)      
}

maior_numero([4, 5, 3, 22, 555, 33])
